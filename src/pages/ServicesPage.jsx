    ...
    <div className="pt-28 pb-12">
      ...
      >
        <div className="p-8 rounded-2xl bg-gradient-to-r from-blue-900 via-slate-900 to-sky-950 text-white shadow-xl">
          <div className="text-xs uppercase font-mono tracking-widest text-sky-300 font-bold">Dedicated Engineering Overview</div>
          <h1 className="text-3xl sm:text-5xl font-extrabold mt-2 font-['Outfit']">
            Turnkey Hospital & Surgical Engineering Services
          </h1>
          <p className="mt-3 text-sm text-sky-100 max-w-3xl leading-relaxed">
            Detailed specifications for Modular Operation Theatres (MOT), Medical Gas Pipeline Systems (MGPS), Cleanroom HVAC, and Luxury Healthcare Finishes.
          </p>
        </div>
      </motion.div>
